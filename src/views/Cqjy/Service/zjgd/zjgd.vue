<template>
    <div class="cjgg-content">
        ...
        <div class="cx-list">
            <ul>
                <li>
                    <router-link to="">xxxxxxxxxx</router-link>
                    <span>2018-08-23</span>
                </li>
            </ul>
        </div>
        <div class="listtabs">
            <router-link to="" class="cur">1</router-link>
    ...
    .cx-list {
        ...
        ul {
            ...
            li {
                ...
                &:hover {
                    filter: invert(51%) sepia(84%) saturate(429%) hue-rotate(92deg) brightness(95%) contrast(86%);
                }
            }
        }
    }
